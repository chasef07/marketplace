// Client-Safe Agent Service - For use in React components
...
export class ClientAgentService {
  ...
  /**
   * Get agent-enabled items for a seller (client-side)
   */
  ...
  /**
   * Get recent agent decisions for a seller (client-side)
   */
  ...
  /**
   * Calculate agent statistics for a seller (client-side)
   */
  ...
  /**
   * Get agent configuration for a seller (client-side)
   */
  ...
  /**
   * Update agent configuration for a seller (client-side)
   */
  ...
  /**
   * Get unread notifications for a seller (client-side)
   */
  ...
  /**
   * Mark notifications as read (client-side)
   */
...
export const clientAgentService = new ClientAgentService();